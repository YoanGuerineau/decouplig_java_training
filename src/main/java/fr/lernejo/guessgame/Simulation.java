...
public class Simulation {
    ...
    private boolean nextRound() {
        ...
        if ( inputNumber < numberToGuess ) {
            logger.log( "Input number is under the number to guess" );
            player.respond( true );
        } else if ( inputNumber > numberToGuess ) {
            logger.log( "Input number is above the number to guess" );
            player.respond( false );
        } else if ( inputNumber == numberToGuess ) {
            logger.log( "Input number is equal to the number to guess, game won" );
            return true;
        }
        return false;
    }
